...
public class SCR_EnemyCrow : MonoBehaviour
{
    ...
    public IEnumerator CrowattackOne()
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            GameObject CrowAttack = Instantiate(Attack, player.transform.position + new Vector3(Random.Range(-2, 2f), Random.Range(-2, 2f),0), Quaternion.identity);
